  ...
  return (
    <div style={{ width: '100%', display: "flex", justifyContent: 'center' }}>
      ...
      <div className="footer">
        <p>Admin Login</p>
        <p onClick={() => window.open("https://api.whatsapp.com/send?phone=089504731540&text=Hallo%20kak%20saya%20ingin%20bergabung%20di%20Quizaze.%20supaya%20pembelajaran%20di%20sekolah%20kami%20jadi%20lebih%20menyenagkan")}>Join School</p>
      </div>
    </div>
  )
}
